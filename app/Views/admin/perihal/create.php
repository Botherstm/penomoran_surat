...
<div class="content-wrapper">
        ...
        <form class="">
            ...
            <div class="input-group justify-content-center mb-3">
                <h2 class="mt-5 mb-5">Tambah Perihal</h2>                
            </div>
            <div class="mb-5 m-1 ">
                 <label for="perihal" class="form-label input-group justify-content-center">Perihal</label>
                 <input type="text" class="form-control w-50 m-auto " id="perihal" aria-describedby="emailHelp">
            </div>
            <div class="mb-5 m-1">
                <label for="kodePerihal" class="form-label input-group justify-content-center">Kode Perihal</label>
                <input type="number" class="form-control w-50 m-auto" id="kodePerihal">
            </div>

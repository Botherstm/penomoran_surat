...
<div class="album-container">
    ...
    <div class="row">
        <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2">
            <h2 class="text-center">Create Data Perihal <?= $sub_perihal['name']; ?></h2>
            <br>
            <form class="album-form" method="POST"
                action="<?php echo base_url() ?>admin/detailsubperihal/save/<?= $sub_perihal['slug']; ?>"
                ...
                <div class="form-group">
                    <label for="name">Nama Detail Sub Perihal</label>
                    <input type="text"
                ...
                <input type="text" class="form-control" id="subperihal_id" value="<?= $sub_perihal['id']; ?>"
                    name="subperihal_id" hidden>
                <div class="form-group">

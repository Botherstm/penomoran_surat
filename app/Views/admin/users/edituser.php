<?= $this->include('admin_super/layouts/header'); ?>
<?= $this->include('admin_super/layouts/sidebar'); ?>
...
<div class="content-wrapper">
  ...
  <div class="form-group">
    ...
    <small id="exampleInputPassword1" class="form-text text-muted">Pastikan password bisa diingat karena akan ter-Encrypt.</small>
  </div>

  <div class="form-group">
    <label for="exampleFormControlInput1">Telp.</label>
    <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="No. Telp">
  </div>
  ...
  <!-- /.content-wrapper -->
  <?= $this->include('admin_super/layouts/footer'); ?>

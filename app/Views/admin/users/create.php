                    ...
                    <div class="modal-content card card-primary">
                        ...
                        <div class="card-body">
                            <form class="card-body" action="<?php echo base_url('generate/save') ?>" method="post"
                                ...
                                <?php if (session()->get('level') == 1): ?>
                                <input type="name" hidden value="<?=session()->get('instansi_id')?>"
                                    name="instansi_id">
                                <div class="form-group">
                                    <label for="bidangSelect">Bidang</label>
                                    <select class="form-control" id="bidangSelect" name="bidang_id">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="name" value="" class="form-control form-control-border" name="instansi"
                                        id="dinas" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nomorSurat">Bidang</label>
                                    <input type="text" value="" class="form-control" name="bidang" id="bidang" readonly>
                                </div>

                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group " style="display: flex;">
                                                <button type="button" class="btn btn-block btn-warning" onclick="openEditModal('<?= $kategori['id'] ?>', '<?= $kategori['name'] ?>', '<?= $kategori['kode'] ?>', '<?= $kategori['slug'] ?>')">
                                                    <i class="fas fa-pen"></i>
                                                </button>
                                                <form style="padding-left: 10px;" id="deleteForm" action="<?php echo base_url('admin/kategori/delete/') ?><?= $kategori['slug']; ?>" method="POST">
                                                    <?= csrf_field(); ?>
                                                    <button type="button" data-target="editmodal" onclick="confirmDelete('<?= $kategori['slug']; ?>')" class="btn btn-block btn-danger">

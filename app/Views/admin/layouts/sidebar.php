<<<<<<< HEAD <aside class="main-sidebar sidebar-light-primary elevation-4" style="position: fixed;">
    =======
    <aside class="main-sidebar sidebar-light-primary elevation-4">
        <!-- Brand Logo -->
        >>>>>>> 7d561f7500b8a4ad6cc93939cd33a9632a3e6ed9
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2 ">
                <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu"
                    data-accordion="false" style=" padding-bottom: 11em; ">
                    <!-- Add icons to the links using the .nav-icon class
               with font-awesome or any other icon font library -->
                    <li class="nav-item ">
                        <<<<<<< HEAD <a href="<?php echo base_url('admin') ?>"
                    ...
                    <li class="nav-item ">
                        <<<<<<< HEAD <a href="<?php echo base_url('admin/users') ?>"

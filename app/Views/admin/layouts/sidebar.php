<aside class="main-sidebar sidebar-light-primary elevation-4" style="position: fixed;">
    ...
    <div class="sidebar">
        ...
        <!-- Sidebar Menu -->
        <nav class="mt-2 ">
            <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu" data-accordion="false" style=" padding-bottom: 15em; ">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item ">
                    <a href="<?php echo base_url('admin/user/profile') ?>" class="nav-link">

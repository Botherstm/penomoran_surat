                    ...
                    <div class="col-md-6" style="padding-right: 1%;">
                        <div class="card">
                            ...
                            <div class="card-footer d-flex">
                                <form method="POST" action="<?php echo base_url('user/profile/updategambar') ?>" accept-charset="UTF-8" id="form_photo" enctype="multipart/form-data">
                                    <div class="row">
                                ...
                                <div class="btn-group">
                                    <!-- update -->
                                    <form id="deleteForm" action="<?php echo base_url('user/profile/delete') ?>" method="POST">
                                        <?= csrf_field(); ?>
                                        <input type="text" hidden value="<?= $user['id']; ?>" name="id">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo base_url('user/profile/update/') ?>">
                    ...
                    <div class="row text-center" style="padding-bottom: 50px;">
                        ...
                        <div class="col-md-6">
                            <button id="submitButton" type="submit" class="btn btn-success" style="width: 150px;">Ubah data</button>
                        </div>
                    </div>
                </form>
            </div>

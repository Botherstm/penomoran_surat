                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <hr>
                            <div class="header-elements mx-auto">
                                <a href="#<?=$user['slug'];?>" class="btn btn-info" style="width: 200px;"
                                    data-toggle="modal" data-target="#editModal"><i class="icon-pencil7"></i> Ganti
                                    Data User</a>
                    ...
                    <div class="col-md-6" style="padding-right: 1%;">
                        <div class="card">
                            ...
                            <div class="card-footer d-flex">
                                <form method="POST" action="<?php echo base_url('user/profile/updategambar') ?>"
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo base_url('user/profile/update/') ?>">
                    ...
                    <div class="form-group text-center">
                        <input type="hidden" value="<?=$user['slug']?>" class="form-control" id="slug" name="slug"
                            readonly>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="password" name="password_lama" class="form-control" id="Password"
                    ...
                    <div class="text-danger" id="passwordMatchError" style="display: none;">Password tidak cocok.
                    </div>
...
function confirmDelete() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.action = "<?php echo base_url('user/profile/delete') ?>";
            form.submit();
        }
    });
}

    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
               ...
               with font-awesome or any other icon font library -->
                <li class="nav-item">
                    <a href="<?php echo base_url('/') ?>"
                        class="nav-link <?= $active == 'home' ? 'active bg-success' : ''; ?>">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                <li class=" nav-item ">
                    <a href=" <?php echo base_url('/public/user/profile') ?>"
                        class="nav-link <?= (current_url(true)->getSegment(1) == 'public' && current_url(true)->getSegment(2) == 'user') ? 'active  bg-success' : ''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url('/tentang') ?>"
                        class="nav-link <?= $active == 'tentang' ? 'active bg-success' : ''; ?>">

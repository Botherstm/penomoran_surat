                    ...
                    <div class="card" style="margin-bottom: 20px;">
                        <div class="card-body">
                            ...
                            <a href="<?php echo base_url('public/riwayat/detail/') ?><?= $generate['slug']; ?>"
                                ...
                                <button
                                    class="p-3 text-info-emphasis bg-info-subtle border border-info-subtle rounded-2">Detail</button>
                            </a>
                            <a href="<?= base_url('pdf/'); ?><?= $generate['pdf']; ?>">
                                <button
                                    class="p-3 text-success-emphasis bg-success-subtle border border-success-subtle rounded-2">Download
                                    PDF</button>
                            </a>

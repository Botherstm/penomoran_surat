                ...
                <div class="card" style="width: 100%; height: 100%; background: #048c7f; border-radius: 27px; margin: 0 auto; ">
                    ...
                    <div class="form-container" style="display: none; padding: 10%; color: white;">
                        ...
                        <form class="text-center">
                            <h1 class="text-center mt-3 mb-3 " style="font-weight: bold;">Generate Nomor Surat (Terlewat)</h1>
                            ...
                            <div class="form-group mb-3">
                                <button class="btn btn-light" type="button" id="generateButton">Generate</button>
                            </div>
                        </form>
                    </div>
                </div>

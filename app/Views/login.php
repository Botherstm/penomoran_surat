                    ...
                    <div class="col-md-5">
                        <div class="card shadow-lg bg-success bg-gradient text-white " style="height: 95%; --bs-bg-opacity: .9;">
                            <div class="card-body ">
                                ...
                                <hr>
                                <div class=" text-center ">
                                    <h6 style=" font-size: small; " ><small>VISI PEMBANGUNAN KABUPATEN BULELENG</small></h6>
                                    <p  style=" font-size: small; " ><small>“TERWUJUDNYA MASYARAKAT BULELENG YANG MANDIRI SEJAHTERA DAN BERDAYA SAING BERLANDASKAN TRI HITA KARANA”</small></p>
                                </div>
                                <div>
                                    <h6 class=" text-center " style=" font-size: small; "><small>MISI PEMBANGUNAN KABUPATEN BULELENG</small></h6>
                                    <small>

                ...
                <div class="row d-flex justify-content-center w-auto p-3 " style="margin: auto; height:5%; margin-top: 1%;">
                    ...
                    <?php if ($cooldownTime > time()) : ?>
                        <div id="cooldown-info" class="alert alert-warning" role="alert">
                            Anda telah mencoba login beberapa kali. Silakan coba lagi dalam <span id="cooldown-counter"></span> detik.
                        </div>
                    <?php endif; ?>

                    <!-- Logo Aplikasi -->
                    <div class="col-md-5">
                        <div class="card shadow-lg bg-success bg-gradient text-white " style="height: 95%; --bs-bg-opacity: .9;">
                            <div class="card-body ">
                                <div class=" text-center">

                                    <img src="<?= base_url('img/logo-kabupaten-buleleng.png') ?>" alt="Pemkab Buleleng" style="max-width: 20%; ">
                                ...
                                <form class="form" method="POST" action="<?php echo base_url('login') ?>">
                                    ...
                                    <div class="mb-3 ">
                                        <div class="input-group">
                                            <input type="name" autofocus class="shadow form-control" name="username" id="exampleInputEmail1" aria-describedby="emailHelp" required placeholder="User Name" style="opacity: 0.7;">
                                            <i class="shadow input-group-text bi bi-person-fill"></i>
                                        </div>
                                    </div>
                                    <div class="mb-2" style="padding-bottom: 6%;">
                                        <div class=" input-group ">
                                            <input type="password" class="shadow form-control " id="exampleInputPassword1" placeholder="Password" name="password" style="opacity: 0.7;">

                                            <span class="shadow input-group-text bi bi-eye-slash" id="showPassword"></span>
                                        </div>
                                    </div>
                                    <div class="g-recaptcha " data-sitekey="<?= $key; ?>" style="width: 100%; max-width: auto; margin: 0 auto;"></div>
                                    <br>

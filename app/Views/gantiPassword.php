                                ...
                                <form id="quickForm" method="post" action="<?= base_url('gantipassworduser'); ?>">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="password" name="password" id="exampleInputPassword1" class="form-control" placeholder="Masukkan Password">
                                                <span class="input-group-text" id="showPassword" style="cursor: pointer;" onclick="togglePassword('exampleInputPassword1', 'passwordIcon')">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="password" name="confirm_password" id="exampleInputPassword2" class="form-control" placeholder="Konfirmasi Password">
                                                <span class="input-group-text" id="showConfirmPassword" style="cursor: pointer;" onclick="togglePassword('exampleInputPassword2', 'confirmPasswordIcon')">
                                    ...
                                    <div style="display: flex; justify-content: space-between; align-items: flex-end; padding-top: 60%;">
                                        <a href="<?= base_url('login'); ?>">
                                            <button type="button" class="btn btn-secondary" style="width: 100px">Batal</button>
                                        </a>
                                        <button type="button" id="submitButton" class="btn btn-primary" style="width: 100px" onclick="validatePassword()">Submit</button>
                                    </div>
                                </form>
